  ...
  return <>
    ...
    <main id="top">
      <section className="hero section-shell" aria-labelledby="hero-title">
        <div className="hero-copy"><p className="eyebrow"><span className="status-dot" aria-hidden="true" />AWS Certified Solutions Architect — Associate · 2026</p><h1 id="hero-title">Cloud systems.<br /><span>Data intelligence.</span></h1><p className="hero-intro">I&apos;m Ahmad Qadafi, PhD—an AWS DevOps and Cloud Engineer with a decade of experience turning complex data into systems, decisions, and measurable outcomes.</p><div className="hero-actions"><a className="button button-primary" href="/projects">Explore my work <span aria-hidden="true">→</span></a><a className="button button-secondary" href="mailto:akqadafi@gmail.com">Start a conversation <span aria-hidden="true">↗</span></a></div></div>
