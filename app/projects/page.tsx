...
export default function ProjectsPage() {
  return <><SiteHeader /><main><section className="page-hero section-shell"><p className="kicker">Selected work · 2019—2026</p><h1>Two disciplines.<br /><span>One systems mindset.</span></h1><p>Cloud platforms and data research may look different, but both depend on the same habits: define the question, make the system observable, test the critical assumptions, and leave behind evidence.</p></section>
    ...
    <section className="projects section-shell data-track" id="data"><div className="section-heading"><div><p className="kicker">02 · Data &amp; Research</p><h2>Evidence that moves<br />decisions forward.</h2></div><p>Research and data systems that turn complex questions into clear findings, practical recommendations, and informed decisions.</p></div><div className="project-list">{dataProjects.map((project) => <ProjectCard project={project} key={project.title} />)}</div></section>
