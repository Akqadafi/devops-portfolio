...
export function DataCaseStudy({ project, findings, outcome }: { project: Project; findings: string[]; outcome: string }) {
  return <><SiteHeader /><main className="case-study">
    ...
    <section className="case-body section-shell"><aside><p className="kicker">At a glance</p>{project.metric && <div className="case-metric"><strong>{project.metric}</strong><span>{project.metricLabel}</span></div>}<p className="source-note">Adapted from Ahmad&apos;s original research portfolio.</p></aside><div className="case-copy">
